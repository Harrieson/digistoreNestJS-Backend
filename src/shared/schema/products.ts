...
export class Products {
  ...
  @Prop({
    default:
      'https://media.istockphoto.com/id/1310406691/vector/coming-soon-text-under-spotlight-vector-illustration-isolated-on-black.jpg?s=1024x1024&w=is&k=20&c=mqnq1t7_7S36XpM_TY0jIzNVxySi5edfSwQEIHSXXBM=',
  })
  image?: string;
